...
public class AccumulatorUnitTest {
    ...
    private def header= "$PROTOCOL,$VERSION,$password", accumulator
    private def packets= [
    "$header|1364787|0|summary|Time Alive=417,Welding=1222,Damage=21627,Damage Taken=347,Deaths=2,Cash Spent=509,Healing=174,Kill Assists=16,Kills=72",
    ...
    "$header|34896207|0|summary|Time Alive=498,Damage=41690,Damage Taken=254,Armor Lost=102,Welding=108,Cash Spent=1119,Healing=147,Deaths=1,Kill Assists=26,Kills=143",
    "$header|34896207|1|weapons|9mm Tactical=152,Hunting Shotgun=32,Nade=3,Shotgun=58,Dual 9mms=39,Knife=11",
    "$header|34896207|2|kills|Clot=98,Gorefast=13,Bloat=5,Crawler=18,Husk=3,Stalker=6",
    "$header|34896207|3|perks|SGSupportSpec=498",
    "$header|34896207|4|actions|Decapitations=56,Received Heal=11,Shot By Husk=3,Healed Teammates=7,Healed Self=1",
    "$header|34896207|5|deaths|Gorefast=1",
    "$header|34896207|6|match|kf-offices|Hell on Earth|Long|1|3|0|0|501|_close"]
    ...
    public void checkPlayerContentCleaner() {
        accumulator.accumulate("kfstatsx-player,2,server|1364787|3|perks|SGDemolitions=417")
        Thread.sleep(5000)
